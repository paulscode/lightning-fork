...
function generate() {
  ...
  PACKAGES="autopilotrpc bridgerpc chainrpc invoicesrpc neutrinorpc offersrpc peersrpc routerrpc signrpc verrpc walletrpc watchtowerrpc wtclientrpc devrpc"
